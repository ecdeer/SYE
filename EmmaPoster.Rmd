...
norfolksm <- ggplot(predict_norfolksm,
  ...
  labs(x = "Growth Period", y = "Length",
       ...
       caption = stringr::str_wrap("Blue line represents the general Von Bertanfly growth model for a collection of clams in a specific location.")) + 
...
plot_RL = ggplot(data = clams_predictions_waterbody,  aes(x = growth_period, y = Length)) +
  ...
  labs(x = "Growth Period", 
       ...
       caption = stringr::str_wrap("Blue line represents the general Von Bertanfly growth model for river vs lake clams.")) +
  theme(plot.title = element_text(size = 20, face = "bold", hjust = 0.5),
        axis.text.x  = element_text(size = 12),
        plot.subtitle = element_text(size = 16),
        axis.title.x = element_text(size = 16),
...
-   Made with a Bayesian framework, where it considers both prior and current information to make a decision to take into account missing data and uncertainty. 
...
maxl_hist = ggplot(data = graphs_df, aes(x = max_l)) +
  geom_histogram(colour = "skyblue4", fill = "skyblue1", bins = 15) +
  facet_wrap(~body) +
  labs(x = "max_l", y = "frequency",
...
k_hist = ggplot(data = graphs_df, aes(x = k)) +
  geom_histogram(colour = "skyblue4", fill = "skyblue1", bins = 15) +
  facet_wrap(~body) +
  labs(x = "k", y = "frequency",
...
# estimate max_l for rivers and lakes 
#river_maxl_line
#lakes_maxl_line
#river_maxl_hist
#lakes_maxl_hist
# estimate k for rivers and lakes
#river_k_line
#lakes_k_line
#river_k_hist
#lakes_k_hist
