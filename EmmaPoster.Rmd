...
Blue line represents the general Von Bertanfly growth model for a collection of clams in a specific location.
...
The blue line represents the general Von Bertanfly growth model for river clams vs lake clams.
...
maxl_hist = ggplot(data = graphs_df, aes(x = max_l)) +
  ...
  facet_wrap(~body) +
  labs(x = "max_l", y = "frequency",
       title = "Histogram of max_l by Lake and River") + 
  theme_minimal(base_size = 24, base_rect_size = 50) +
  theme(plot.title = element_text(size = 20, face = "bold", hjust = 0.5),
        axis.text.x  = element_text(size = 12),
        plot.subtitle = element_text(size = 16),
...
- River clams have much higher asymptotic length than lake clams, meaning that river clams grow to longer overall lengths. 

- Lake clams have a faster growth rate than river clams, meaning that lake clams reach their asymptotic length twice as fast as river clams. 
...
- Rivers flowing nature promotes long-term growth by continuously delivering organic particles for filter feeding and maintaining higher dissolved oxygen levels, explaining the longer length.
